...
import ru.madbrains.domain.model.response.Code
import ru.madbrains.domain.model.response.Intercom
import ru.madbrains.domain.model.response.Settings.Roommate
