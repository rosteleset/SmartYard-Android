...
class NoNetworkFragment : Fragment() {
    ...
    private val delegate: NoNetworkDelegate? by injectOrNull(NoNetworkDelegate::class.java)
    ...
    private val servicesList = mutableListOf(
        ...
        ItemService(name = "Телевидение", check = false),
        ItemService(name = "Телефония", check = false)
    )
