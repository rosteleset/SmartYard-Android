...
class OnboardingActivity : CommonActivity() {
    ...
    private val delegate: OnboardingDelegate? by injectOrNull(OnboardingDelegate::class.java)
    private lateinit var pages: MutableList<OnboardingPageModel>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        delegate?.extendConfig(binding, pages)

        // Run strictly after the delegate
        setupPager()
    }
